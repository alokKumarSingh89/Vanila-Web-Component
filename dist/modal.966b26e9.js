...
function (_HTMLElement) {
  ...
  function Modal() {
    ...
    var cancelBtn = _this.shadowRoot.querySelector("#cancel-btn");

    var confirmBtn = _this.shadowRoot.querySelector("#confirm-btn");

    cancelBtn.addEventListener('click', _this._cancel.bind(_assertThisInitialized(_this)));
    confirmBtn.addEventListener('click', _this._confirm.bind(_assertThisInitialized(_this)));
    return _this;
  ...
  _createClass(Modal, [{
    ...
    value: function _confirm() {
      this.hide();
      var CancelEvent = new Event('confirm');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/modal.js"], null)
//# sourceMappingURL=/modal.966b26e9.js.map